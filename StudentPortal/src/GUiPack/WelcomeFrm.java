...
public class WelcomeFrm extends javax.swing.JFrame {
    ...
    void call_Login_Servlet() {
        try {
            ...
            String urlstr = "http://" + CommonVariable.serverIp + ":8084/PortalServer/StudentLoginServlet";
            ...
            responseObj = (StudentDetails) in.readObject();

            in.close();

            if (responseObj != null) {
                //   JOptionPane.showMessageDialog(this, "Teacher Login Successful");
                CommonVariable.stName = responseObj.stname;
                CommonVariable.studentClass = responseObj.classId;
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagePack/students.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jTextField1.getText().isEmpty() || jPasswordField2.getPassword().equals("")) {
            JOptionPane.showMessageDialog(this, "All Fields are Mandatory");
            return;
        } else {
            obj = new StudentDetails();
            obj.RollNO = Integer.parseInt(jTextField1.getText());
            obj.pwd = new String(jPasswordField2.getPassword());
            call_Login_Servlet();
        }
