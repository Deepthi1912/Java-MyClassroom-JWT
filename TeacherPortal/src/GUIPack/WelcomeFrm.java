...
public class WelcomeFrm extends javax.swing.JFrame {
    ...
    void call_Login_Servlet() {
        try {
            ...
            String urlstr = "http://" + CommonVariable.serverIp + ":8084/PortalServer/TeacherLoginServlet";
            ...
            TeacherDetails responseObj = (TeacherDetails) in.readObject();

            in.close();

            if (responseObj != null) {
                //   JOptionPane.showMessageDialog(this, "Teacher Login Successful");
                CommonVariable.uname = jTextField1.getText();
                CommonVariable.teacherId = responseObj.id;
                CommonVariable.name = responseObj.name;
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Enter Teacher UserName");

        jLabel4.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 218, 0));
        jLabel4.setText("Enter Teacher Password");
